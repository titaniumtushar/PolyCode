...
import { generateMultipleUrls } from "./s3upload"; // Import the function
...
export async function signup(req: any, res: any, role: role) {
    try {
        ...
        // Call generateMultipleUrls if the role is "U"
        if (role === "U") {
        ...
        // For role "C", just send the signup success message
